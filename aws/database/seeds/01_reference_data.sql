...
-- Description: Seed data for reference tables
-- Version: 2.0
-- Date: 2025-12-01
-- =====================================================

-- =====================================================
-- SECTION 1: COUNTRIES & STATES
-- =====================================================

INSERT INTO ref_countries (name, code, is_active) VALUES
('India', 'IN', true),
('United States', 'US', false),
('United Kingdom', 'UK', false)
ON CONFLICT (code) DO NOTHING;

INSERT INTO ref_states (name, code, country_code, is_active) VALUES
-- Major poultry states in India
('Andhra Pradesh', 'AP', 'IN', true),
('Telangana', 'TG', 'IN', true),
('Tamil Nadu', 'TN', 'IN', true),
('Maharashtra', 'MH', 'IN', true),
('West Bengal', 'WB', 'IN', true),
('Karnataka', 'KA', 'IN', true),
('Gujarat', 'GJ', 'IN', true),
('Haryana', 'HR', 'IN', true),
('Punjab', 'PB', 'IN', true),
('Uttar Pradesh', 'UP', 'IN', true),
('Madhya Pradesh', 'MP', 'IN', true),
('Rajasthan', 'RJ', 'IN', true),
('Bihar', 'BR', 'IN', true),
('Odisha', 'OR', 'IN', true),
('Kerala', 'KL', 'IN', true),
('Assam', 'AS', 'IN', true),
('Jharkhand', 'JH', 'IN', true),
('Chhattisgarh', 'CG', 'IN', true),
('Uttarakhand', 'UK', 'IN', true),
('Himachal Pradesh', 'HP', 'IN', true),
('Jammu and Kashmir', 'JK', 'IN', true),
('Goa', 'GA', 'IN', true),
('Manipur', 'MN', 'IN', true),
('Meghalaya', 'ML', 'IN', true),
('Tripura', 'TR', 'IN', true),
('Mizoram', 'MZ', 'IN', true),
('Nagaland', 'NL', 'IN', true),
('Arunachal Pradesh', 'AR', 'IN', true),
('Sikkim', 'SK', 'IN', true),
('Delhi', 'DL', 'IN', true),
('Puducherry', 'PY', 'IN', true),
('Chandigarh', 'CH', 'IN', true)
