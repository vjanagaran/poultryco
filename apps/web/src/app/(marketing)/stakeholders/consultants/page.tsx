...
export const metadata: Metadata = {
  title: "For Poultry Consultants | PoultryCo",
  description: "Grow your consulting practice. Showcase expertise. Reach 5,000+ farms. Build verified profile. Share knowledge. 0% commission.",
  keywords: ["poultry consultant", "farm consultant India", "poultry business advisor", "farm management consultant"],
  openGraph: {
    title: "For Poultry Consultants | PoultryCo",
    description: "Build verified profile. Showcase expertise. Reach 5,000+ potential clients.",
    type: "website",
  },
};
        ...
        <div className="container mx-auto px-6 py-16 lg:py-20">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-foreground/70 mb-8">
              Build verified profile. Showcase case studies. Get discovered by farms seeking expert guidance. 0% commission on your fees.
            </p>
      ...
      <section className="py-16 lg:py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="bg-gradient-to-r from-primary to-primary/90 rounded-3xl p-12 text-center text-white max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Reach 5,000+ Potential Clients</h2>
