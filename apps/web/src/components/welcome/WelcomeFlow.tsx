          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span><strong>Rajesh K.</strong> from Namakkal just joined • 2 min ago</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                <span><strong>Dr. Priya S.</strong> completed her veterinarian profile • 15 min ago</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                <span><strong>Dev Update:</strong> Expert verification system shipped ✅ • 2 hours ago</span>
              </div>
            </div>
          </div>
        </div>
